...
</style><div id="Profile" class="list"><h1><b><?php echo L(Profile_info);?></b><span>Profile&nbsp; Info</span></h1><ul><?php if(is_array($userinfo)): $i = 0; $__LIST__ = $userinfo;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><li><span><?php echo L($key);?>:</span><?php echo ($v); ?></li><?php endforeach; endif; else: echo "" ;endif; ?></ul></div><div id="system"  class="list"><h1><b><?php echo L(system_info);?></b><span>System&nbsp; Info</span></h1><ul><?php if(is_array($server_info)): $i = 0; $__LIST__ = $server_info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><li><span><?php echo L($key);?>:</span><?php echo ($v); ?></li><?php endforeach; endif; else: echo "" ;endif; ?></ul></div></body></html>