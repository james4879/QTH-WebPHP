    ...
    */
    function PPTBox()
    {
        ...
        this.picHeight = 23;//小图高度
        this.autoplayer = 23;//自动播放间隔（秒）
        this.target = "_blank";
        this._box = [];
        this._curIndex = 0;
    }
    PPTBox.prototype =
    {
        ...
        _init : function (){
            ...
            for(var i=0;i<this._box.length;i++){
                ...
                imageHTML ="<div class='bitdiv "+((i==0)?"curimg":"defimg")+"' title ="+parame.title+" src='bit01.gif' "+picstyle+" onclick = \""+eventstr+".clickPic("+i+")\"  onmouseover=\""+eventstr+".mouseoverPic("+i+")\">"+j+"</div>" + imageHTML;
            }
